...
function ModelModule({
  slot, title, folio, icon: Icon, description, data, loading, onPull, onActivate, onRemove, isPullInProgress
}: ModelModuleProps) {
  if (!data) return null
...
function AudioModule({
  title, folio, icon: Icon, description, data, loading, onPull, onActivate, onRemove, isPullInProgress
}: AudioModuleProps) {
  if (!data) return null
